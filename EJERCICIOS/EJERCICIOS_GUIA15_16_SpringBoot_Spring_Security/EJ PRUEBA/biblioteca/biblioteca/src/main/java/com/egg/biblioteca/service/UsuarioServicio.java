...
public class UsuarioServicio implements UserDetailsService {
    ...
    public void actualizarAdmin(MultipartFile archivo, Long id, String nombre, String mail, String password, String password2) throws MiException {
        validar(nombre, mail, password, password2);
    ...
    public UserDetails loadUserByUsername(String mail) throws UsernameNotFoundException {
        ...
        if (u != null) {
            ...
            //SE SETEAN LOS ATRIBUTOS DEL USUARIO BUSCADO EN BD (linea 128)
