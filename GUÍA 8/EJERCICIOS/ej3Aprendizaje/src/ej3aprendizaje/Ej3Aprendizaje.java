...
import ej3aprendizaje.services.BarajaService;
import ej3aprendizaje.services.CartaService;
...
public class Ej3Aprendizaje {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------------");
        cs.crearCartas(mazo);
        System.out.println("LONG MAZO: " + mazo.size());
        bs.mostrarMazo(mazo);
        ...
        System.out.println("----------------");
        bs.siguienteCarta(mazo, aux);
        bs.cartasDisponibles(mazo);
        
        System.out.println("\n----------------");
        System.out.println("NUMERO CARTAS");
        System.out.println("----------------");
        bs.darCartas(mazo, aux);
        bs.cartasDisponibles(mazo);
        
        bs.cartasMonton(aux);
        
        bs.mostrarBaraja(mazo);
